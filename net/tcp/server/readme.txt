/**
  ...
  * @file    tcp_sever/readme.txt 
  * @author  MDWG (MiCO Documentation Working Group)
  * @version v2.4.x
  * @date    11-April-2016
  * @brief   Description of the  "tcp_sever"  demo.
  ******************************************************************************
...
@par Directory contents 
    - Demos/tcpip/tcp_sever/tcp_sever.c      TCP server demo program
    - Demos/tcpip/tcp_sever/mxos_config.h    MiCO function header file
