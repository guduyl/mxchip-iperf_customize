...
#define MQTT_CLIENT_ID         "mxos_MQTT_Client"
...
#define MQTT_CLIENT_PUB_MSG     "mxos_mqtt_client_test_data_1234567890"
...
merr_t user_send_handler( void *arg );
merr_t user_recv_handler( void *arg );
...
static merr_t mqtt_client_release( Client *c, Network *n)
{
    merr_t err = kNoErr;
