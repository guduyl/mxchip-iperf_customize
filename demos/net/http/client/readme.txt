/**
  @page " http_client "  demo
  
  @verbatim
  ******************** (C) COPYRIGHT 2016 MXCHIP MiCO SDK*******************
  * @file    http_client/readme.txt 
  * @author  MDWG (MiCO Documentation Working Group)
  * @version v2.4.x
  * @date    11-April-2016
  * @brief   Description of the  "http_client"  demo.
  ******************************************************************************

  @par Demo Description 
  This demo shows:  how to start http client to get specify web site information, after Easylink configuration.


@par Directory contents 
    - Demos/tcpip/mDNS/mdns.c           Zero-configuration networking demo
    - Demos/tcpip/mDNS/mxos_config.h    MiCO function header file
