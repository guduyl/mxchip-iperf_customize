/**
  @page " tls_client "  demo
  
  @verbatim
  ******************** (C) COPYRIGHT 2016 MXCHIP MiCO SDK*******************
  * @file    tls_client/readme.txt 
  * @author  WES
  * @version v1.0.0
  * @date    24-March-2020
  * @brief   Description of the  "tls_client"  demo.
  ******************************************************************************

  @par Demo Description 
  This demo shows:  how to start a tls client to connect a specifical server after wifi connection.


@par Directory contents 
    - demos/net/tls_client/
