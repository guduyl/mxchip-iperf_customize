/**
  @page "tcp_client"  demo
  
  @verbatim
  ******************** (C) COPYRIGHT 2016 MXCHIP MiCO SDK*******************
  * @file    tcp_client/readme.txt 
  * @author  MDWG (MiCO Documentation Working Group)
  * @version v2.4.x
  * @date    11-April-2016
  * @brief   Description of the  "tcp_client"  demo.
  ******************************************************************************


 @par Demo Description 
    - This demo shows:  how to start a tcp client and communicate with romote sever.


@par Directory contents 
    - Demos/tcpip/tcp_client/tcp_client.c     TCP client demo program
    - Demos/tcpip/tcp_client/mxos_config.h    MiCO function header file
