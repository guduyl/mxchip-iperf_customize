...
T_APP_RESULT app_profile_callback(T_SERVER_ID service_id, void *p_data)
{
    ...
    else if (service_id == simp_srv_id)
    {
        ...
        case SERVICE_CALLBACK_TYPE_INDIFICATION_NOTIFICATION:
        {
            ...
            {
                app_log("SIMP_NOTIFY_INDICATE_V4_ENABLE");
            }
            break;
            case SIMP_NOTIFY_INDICATE_V4_DISABLE:
            {
                app_log("SIMP_NOTIFY_INDICATE_V4_DISABLE");
            }
            break;
            default:
                break;
        ...
        case SERVICE_CALLBACK_TYPE_INDIFICATION_NOTIFICATION:
            {
                ...
                case BAS_NOTIFY_BATTERY_LEVEL_ENABLE:
                    {
                        app_log("BAS_NOTIFY_BATTERY_LEVEL_ENABLE");
                    }
                    break;

                case BAS_NOTIFY_BATTERY_LEVEL_DISABLE:
                    {
                        app_log("BAS_NOTIFY_BATTERY_LEVEL_DISABLE");
                    }
                    break;
                default:
                    break;
        ...
        case SERVICE_CALLBACK_TYPE_READ_CHAR_VALUE:
            {
                if (p_bas_cb_data->msg_data.read_value_index == BAS_READ_BATTERY_LEVEL)
                {
                    ...
                    app_log("BAS_READ_BATTERY_LEVEL: battery_level %d", battery_level);
