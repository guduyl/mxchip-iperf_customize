...
/** @addtogroup  CENTRAL_GAP_MSG
    * @{
    */
T_APP_LINK app_link_table[BLE_CENTRAL_APP_MAX_LINKS];
/** @} */
...
{
    app_log("app_save_srvs_hdl_table");
...
uint32_t app_load_srvs_hdl_table(T_APP_SRVS_HDL_TABLE *p_info)
{
    ...
    app_log("app_load_srvs_hdl_table: result %ld", result);
    if (result)
    {
