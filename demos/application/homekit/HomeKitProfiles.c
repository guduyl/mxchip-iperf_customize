/**
 ******************************************************************************
 * @file    HomeKitProfile.c
 * @author  William Xu
 * @version V1.0.0
 * @date    05-May-2014
 * @brief   This file provide HomeKit profile definition for this application.
 ******************************************************************************
...
{
  .num_of_services = sizeof(micokit_demo_services) / sizeof(struct _hapService_t),
