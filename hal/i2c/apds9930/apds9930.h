...
/** @defgroup MXOS_Sensor_Driver MXOS Sensor Driver
  * @brief Provide driver interface for MXOS Sensor Devices
  * @{
  */
...
/** @defgroup MXOS_ADPS9930_Driver MXOS ADPS9930 Driver
  ...
  */
  ...
  #define APDS9930_I2C_DEVICE      MXOS_I2C_2
#endif
